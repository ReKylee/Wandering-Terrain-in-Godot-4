extends Node3D
class_name WanderingTerrain

#--------Semi integrated Player-following. Modify as needed for now.--------------
...
#var snap_step = 20 #Distance required to update the uv map.
#var div = 2243 #Dimentions of the clip plane mesh
#
